	...
	return (
		...
		>
			...
			<div className="relative w-8 h-8 group-hover:opacity-100 lg:opacity-0 transition-opacity">
				<ChevronIcon className="absolute aspect-square h-full fill-foreground group-hover:motion-safe:animate-arrows left-1" />
				<ChevronIcon className="absolute aspect-square h-full fill-foreground group-hover:motion-safe:animate-arrows delay-75" />
			</div>
		</Link>
	);
};
