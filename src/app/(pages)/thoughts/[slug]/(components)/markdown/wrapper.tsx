		...
		<section className="relative opacity-0 [--delay:500ms] motion-safe:animate-in md:px-10 xl:flex">
			<div
				className={cn(
					...
					"not-print:prose-inline-code:mx-1 prose-inline-code:rounded-md not-print:prose-inline-code:bg-container not-print:prose-inline-code:p-1",
				...
				<Markdown
					components={{
						...
						img(props: JSX.IntrinsicElements["img"] & ExtraProps) {
							...
							return (
								<MarkdownImage src={src} allImages={images} alt={props.alt} />
							);
						},
