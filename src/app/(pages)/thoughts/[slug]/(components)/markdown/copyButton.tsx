...
export const CopyButton: React.FC<{
    ...
    return (
        <button
            ...
            type="button"
            className={cn(
                "group relative z-10 transition-all duration-200 cursor-pointer",
                className
            )}
        ...
        >
            ...
            <span
                className={cn(
                    "absolute translate-full top-0 right-0 h-40 w-40 rounded-full bg-success transition-all duration-200",
